...
object WifiQrGenerator {
    ...
    fun validatePassword(password: String): ValidationResult =
        when {
            ...
            WifiValidationRules.isPasswordTooShort(
                password,
            ) -> ValidationResult.Error(R.string.error_password_too_short)
     ...
     */
    internal fun generateWifiStringUnchecked(
        ssid: String,
        password: String,
    ): String {
        val escapedSsid = escapeWifiString(ssid)
