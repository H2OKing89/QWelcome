...
class TemplateListScreenTest {
    ...
    fun newTemplate_isTopBarActionAndOpensEditor() {
        ...
        composeRule
            .onNodeWithContentDescription(appContext.getString(R.string.action_new_template))
            .assertIsDisplayed()
            .performClick()
    ...
    fun activeTemplate_isPinnedFirstAndLabeled() {
        ...
        val activeTop =
            composeRule
                .onNodeWithText(englishTemplate.name)
                .fetchSemanticsNode()
                .boundsInRoot.top
        val defaultTop =
            composeRule
        ...
        composeRule
            .onNodeWithContentDescription(appContext.getString(R.string.content_desc_active_template))
            .assertIsDisplayed()
    }
    ...
    fun userTemplateOverflow_exposesAllSecondaryActions() {
        ...
        composeRule
            .onNodeWithText(appContext.getString(R.string.action_edit_template))
            .assertIsDisplayed()
        composeRule
            .onNodeWithText(appContext.getString(R.string.action_rename_template))
            .assertIsDisplayed()
        composeRule
            .onNodeWithText(appContext.getString(R.string.action_preview_template))
            .assertIsDisplayed()
        composeRule
            .onNodeWithText(appContext.getString(R.string.action_duplicate_template))
            .assertIsDisplayed()
        composeRule
            .onNodeWithText(appContext.getString(R.string.action_delete_template))
            .assertIsDisplayed()
    }
    ...
    fun defaultOverflow_onlyExposesCustomizeAndPreview() {
        ...
        composeRule
            .onNodeWithText(appContext.getString(R.string.action_customize_copy))
            .assertIsDisplayed()
        composeRule
            .onNodeWithText(appContext.getString(R.string.action_preview_template))
            .assertIsDisplayed()
    ...
    fun searchAndClear_restoreTemplateResults() {
        ...
        composeRule
            .onNodeWithText(appContext.getString(R.string.text_no_templates_match, query))
            .assertIsDisplayed()

        composeRule
            .onNodeWithContentDescription(appContext.getString(R.string.content_desc_clear_search))
            .performClick()
    ...
    fun tagSheet_appliesMultipleFiltersWithOrSemanticsAndClears() {
        setScreenContent()
        val builtInTemplateName =
            viewModel.uiState.value.templates
        ...
        composeRule
            .onNodeWithContentDescription(appContext.getString(R.string.action_close))
            .performClick()

        composeRule
            .onNodeWithText(appContext.getString(R.string.label_tags_selected, 2))
            .assertIsDisplayed()
        composeRule.onNodeWithText(englishTemplate.name).assertIsDisplayed()
    ...
    fun overflowTap_doesNotActivateInactiveTemplateOrRecordUse() {
        ...
        val usageBefore =
            viewModel.uiState.value.templateLastUsedAt
                .toMap()
    ...
    fun renameDialog_unchangedNameShowsHint() {
        ...
        composeRule
            .onNodeWithText(appContext.getString(R.string.hint_name_unchanged))
            .assertIsDisplayed()
        composeRule
            .onNodeWithText(appContext.getString(R.string.action_rename_template))
            .assertIsNotEnabled()
    ...
    fun invalidCard_isBlockedAndFixOpensEditor() {
        ...
        composeRule
            .onNodeWithContentDescription(appContext.getString(R.string.content_desc_invalid_template))
            .assertIsDisplayed()
        composeRule
            .onNodeWithContentDescription(
    ...
    fun selectingLastTemplate_keepsCardVisibleWhileSnackbarIsDisplayed() {
        ...
        composeRule
            .onNodeWithTag(TEMPLATE_LIST_TEST_TAG)
            .performScrollToIndex(templates.lastIndex)
        val lastTemplateCard =
            composeRule.onNodeWithContentDescription(
