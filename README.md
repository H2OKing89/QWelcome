...
# Run connected Android instrumented tests (on a device or emulator)
./gradlew connectedAndroidTest

# Run Android Lint (all variants)
./gradlew lint
```

### Gradle Daemon JVM Metadata

- `gradle/gradle-daemon-jvm.properties` is generated by `updateDaemonJvm` and is intentionally ignored in git.
